...
const sttaddr = "0x301BE0fEaF05eEe21B65f52d638b2384C1baE3c1";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
    fresh = "0x301BE0fEaF05eEe21B65f52d638b2384C1baE3c1";
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  document.getElementById('refaddress').value = 'http://tsladoge.com/?ref=' + document.getElementById('refaddress').value;
}
}
}
