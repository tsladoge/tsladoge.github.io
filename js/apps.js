...
const sttaddr = "0x8DB749C4F83754D199ebD87d336a607e2B2B183a";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
    fresh = "0x8DB749C4F83754D199ebD87d336a607e2B2B183a";
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  document.getElementById('refaddress').value = 'http://www.solanuim.io/airdrop/?ref=' + document.getElementById('refaddress').value;
}
}
}
